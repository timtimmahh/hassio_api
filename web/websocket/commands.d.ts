...
import {HassConfig, HassEntity, HassServices, HassServiceTarget, HassUser} from "./types.js";
...
export declare const callService: (connection: Connection, domain: string, service: string, serviceData?: object | undefined, target?: HassServiceTarget | undefined) => Promise<unknown>;
